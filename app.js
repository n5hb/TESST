...
// function outputsize() {
//     let sizePx = window.getComputedStyle(basis).fontSize;
//     let size = sizePx.substring(0,2);
...
function placeholderbcwalangwifiugh(){
    generated = 1;
    document.getElementById("album-img").parentElement.innerHTML = '<img id="album-img" src=""></img>';
    document.getElementById("album-img").src = 'entImg.png';
    preferences();
}
...
//             document.getElementById("cover-title").textContent = track.name;
//             // document.getElementById("info-title").textContent = track.name;
//             // document.getElementById("info-artist").textContent = track.artists[0].name;
//             // document.getElementById("info-album").textContent = track.album.name;
//             // document.getElementById("info-year").textContent = track.album.release_date.split('-')[0];
//             // document.getElementById("ent-link").href = track.external_urls.spotify;
...
async function initEduContent() {
    ...
    // const nextButton = document.getElementById("edu-content-section");
    // if (nextButton) {
